...
CREATE TABLE IF NOT EXISTS registros (
  ...
  "maquinaId"          TEXT,
  "maquinaNome"        TEXT,
  "maquinaDestinoId"   TEXT,
  "maquinaDestinoNome" TEXT,
  "hardwareId"         TEXT,
  "hardwareSN"         TEXT,
  "hardwareNome"       TEXT,
  "hardwareTipo"       TEXT,
  "hardwareModelo"     TEXT,
  "hardwarePatrimonio" TEXT,
  "gpsLat"             TEXT,
  "gpsLng"             TEXT,
  "gpsAcc"             TEXT,
  "dataHora"           TEXT,
...
-- ── PERMISSÕES (anon pode ler e escrever) ────────────────────────
...
INSERT INTO maquinas (id, nome, tipo, ano, unidade, chassi, patrimonio, "centroCusto", "criadoEm") VALUES
